      ...
      <div className="section-container">
        ...
        <div className="gallery-block">
          ...
          <div className="latent-gallery">
            <img src={L1} alt="Latent variation 1" className="latent-image"/>
            <img src={L2} alt="Latent variation 2" className="latent-image"/>
            <img src={L3} alt="Latent variation 3" className="latent-image"/>
            <img src={L4} alt="Latent variation 4" className="latent-image"/>
          </div>
        </div>
      </div>
    </section>
